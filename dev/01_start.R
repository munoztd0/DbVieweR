...
golem::fill_desc(
  ...
  repo_url = "https://github.com/munoztd0/DbVieweR" # The URL of the GitHub Repo (optional)
)
...
usethis::use_mit_license("David Munoz Tord") # You can set another license here
# usethis::use_readme_rmd(open = TRYE)
